...
import { NativeBaseProvider, Box, FlatList, Image,Spinner } from "native-base";
...
export default function All() {
  ...
  const fetchNews = async () => {
    var result = await getData('general');
    setNewsData(result);
  ...
  let [fontsLoaded] = useFonts({
    ...
    'Poppinss':require('../../assets/fonts/Poppins-BlackItalic.ttf')
  })
    ...
    <NativeBaseProvider>
      <View>
          ...
          renderItem={({ item }) => (
            <View style={{ padding: 10 }}>
              <View>
                ...
                }} alt="Alternate Text" keyExtractor={item=>item.id} />
              </View>
              <View >
        ...
        />
          ...
          <View style={{display:'flex',justifyContent:'center',alignItems:'center',height:700}}>
...
// make a form for student registeration in nativebase